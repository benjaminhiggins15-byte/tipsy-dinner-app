...
- Account-to-account sharing's own standing cleanup/watch items (the long-lived receive branch, the send-sheet label, cache-clear/cook_time gaps, receiving aesthetic passes, etc.) live in their respective FEATURE_SPECS.md build sections, not here.
